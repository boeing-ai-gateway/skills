...
- Use LibreOffice (`soffice`) and Poppler (`pdftoppm`) to render sheets for visual review:
...
Prefer `uv` for dependency management. Set up a venv before installing packages.
